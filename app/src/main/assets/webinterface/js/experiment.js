...
var selectInput = {
    ...
    template: '<select class="select" id="block-type-select" v-model="currentBlock.value"><option v-for="anim in pointAtTypes" :value="anim">{{anim}}</option></select>'
}
